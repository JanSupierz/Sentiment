...
\begin{equation}	
	\precision_{\instanceClass} = 	\frac{\text{TP}_{\instanceClass}}{\text{TP}_{\instanceClass} + \text{FP}_{\instanceClass}}
\end{equation}
%
\begin{equation}
	\recall_{\instanceClass} = \frac{\text{TP}_{\instanceClass}}{\text{TP}_{\instanceClass} + \text{FN}_{\instanceClass}}
\end{equation}
%
\begin{equation}
