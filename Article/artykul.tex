...
$s_{ijkl}$ is the sentiment associated with the $j$-th aspect of $i$-th entity expressed by the $k$-th opinion holder in $l$-th time moment \ksremark{Czy to dobrze zrozumiałem?}. 
According to this formulation, the ultimate goal of sentiment analysis is the extraction of all opinion quintuples present in a collection of texts \cite{azzeddine2018sentiment}.
...
Traditional sentiment analysis methods can be broadly divided into lexicon-based approaches and supervised machine learning techniques \cite{azzeddine2018sentiment, sharma2025review}. More recently, deep learning architectures such as 
