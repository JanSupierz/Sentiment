...
Sentiment analysis (or opinion mining) is an umbrella term for the computational study of people's opinions, sentiments, emotions, and attitudes expressed in written language \cite{bib:Liu2012sentiment}. The term includes field names and slightly different tasks associated with them: sentiment analysis, opinion mining, opinion extraction, sentiment mining, subjectivity analysis, affect analysis, emotion analysis, review mining, etc. \cite{bib:Liu2012sentiment} However, the main terms in academia remain both: sentiment analysis and opinion mining \cite{bib:Liu2012sentiment}. 
...
Despite its importance, sentiment analysis faces several fundamental challenges \cite{sharma2025review}. Language is inherently ambiguous: the same word can convey different sentiments depending on context. Sarcasm, irony, and domain-specific expressions further complicate the task. Models often struggle with multiple languages \cite{sharma2025review}. Moreover, vocabulary evolves rapidly; new words, slang, and abbreviations appear constantly, especially in social media \cite{sharma2025review}. Any practical system must therefore be robust to such linguistic shifts \cite{sharma2025review}.
