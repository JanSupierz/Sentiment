...
Tools such as \textsc{WordNet-Affect} \cite{wordnet-affect} and \textsc{SentiWordNet} \cite{sentiwordnet2010} provide foundational lexical resources for sentiment analysis \cite{nursal2025battle}.
