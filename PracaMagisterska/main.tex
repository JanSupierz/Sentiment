...
\begin{enumerate}
	...
	\begin{itemize}
		...
		\item Impact of filtering (Sec.~\ref{sec:Impact-of-Filtering})
		\item Impact of custom vectorization (Sec.~\ref{sec:Impact-of-Custom-Vectorization})
		\item Impact of vocabulary depth (Sec.~\ref{sec:Impact-of-Vocabulary-Depth})
		\item Impact of semantic clustering (Sec.~\ref{sec:Impact-of-Semantic-Clustering})
	\end{itemize}
	
	\item \textbf{Cascade System Experiment:}
	\begin{itemize}
		\item Impact of certainty (Sec.~\ref{sec:Impact-of-Certainty})
		\item Impact of cascade ensemble (Sec.~\ref{sec:Impact-of-Cascade-Ensemble})
	\end{itemize}
\end{enumerate}
